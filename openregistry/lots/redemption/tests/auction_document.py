...
from openregistry.lots.redemption.tests.blanks.auction_document_blanks import (
...
from openregistry.lots.redemption.constants import AUCTION_DOCUMENT_TYPES
